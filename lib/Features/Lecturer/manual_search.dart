...
class _ManualSearchState extends State<ManualSearch> {
  ...
  void _performSearch(String query) async {
    final String q = normalizeReg(query);
    if (q.isEmpty) {
      setState(() => _results = []);
      return;
    }
    ...
    try {
      // Search by normalized reg no (stored as lowercase with dashes)
  ...
  void _addStudent(Map<String, String> student) {
    ...
    _showSnack('Added: ${student['name']} ${student['surname']}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ValueListenableBuilder<List<Map<String, String>>>(
        valueListenable: AttendanceState.markedStudents,
        builder: (context, markedList, _) {
          return Column(
                ...
                child: _results.isEmpty && _ctrl.text.isNotEmpty && !_isLoading
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          // Use AttendanceState to check if already marked
                          final bool alreadyAdded =
                              AttendanceState.isMarked(reg);
